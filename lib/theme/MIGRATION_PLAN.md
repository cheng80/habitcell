...
2. 모든 `import 'package:habitcell/theme/config_ui.dart'`를 `import 'package:habitcell/util/config_ui.dart'`로 변경
...
**import 변경**:
- `import 'package:habitcell/theme/app_colors.dart'` → `import 'package:habitcell/theme/app_theme_colors.dart'`
